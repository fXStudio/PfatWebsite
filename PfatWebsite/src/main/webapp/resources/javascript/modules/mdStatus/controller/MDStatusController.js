Ext.define('MDStatusModule.controller.MDStatusController', {
    extend: 'Ext.app.Controller',
    stores: ['MDStatus'],// 存储器
    refs: [
       {ref: 'gridPanel', selector: 'mdstatusgrid'},
       {ref: 'window', selector: 'mdstatuswindow'},
       {ref: 'formPanel', selector: 'mdstatusform'},
	    ...
	    this.control({'textfield[name=searchField]': {
	                    ...
	                    gridPanel.getStore().filter({
	                        filterFn: function(item) {
	                            return !field.getValue() || 
	                                   item.get("statusName") && item.get("statusName").indexOf(field.getValue()) > -1; 
	                        }
	                    });
	                }
	            }
	    	...
	    	'button[action=add]':{
	    		click: function(){
	            	...
	            	if(!menuItemWindow){menuItemWindow = Ext.create('MDStatusModule.view.MDStatusWindow');}
	        ...
	        'mdstatuswindow': {
	        	show: function(){
    	            Ext.getCmp('statusname').focus(true, 100);
	        	}
	        }
        })
    },
