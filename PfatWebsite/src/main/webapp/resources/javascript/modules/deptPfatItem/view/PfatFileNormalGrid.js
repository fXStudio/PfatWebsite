Ext.define('DeptPfatItemModule.view.PfatFileNormalGrid', {
    ...
    initComponent: function() {
        // Create Store Object
        var store = Ext.create('DeptPfatItemModule.store.PfatFileNormalStore');
        var me = this;
            ...
            tbar: {
            	...
            	items: [Ext.create('Ext.form.Panel', {
                    ...
                    items: [{
                        text: '上传文件',
                        handler: function(){
                            var form = Ext.getCmp('normalGrid').getForm();
                            if(form.isValid()){
                        ...
                        text: '重置',
                        handler: function() {
                            Ext.getCmp('normalGrid').getForm().reset();
                        }
                    }, '->',  '<span class="warn_msg" style="color:red">* 注意: 文件名称应能够清晰表达目的, 这里文档绩效考核</span>']
            	}]
            }
        });
