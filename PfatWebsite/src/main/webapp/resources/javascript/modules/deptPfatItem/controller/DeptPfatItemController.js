Ext.define('DeptPfatItemModule.controller.DeptPfatItemController', {
    extend: 'Ext.app.Controller',
    stores: ['PfatItemStore'],// 存储器
    refs: [
       {ref: 'gridPanel', selector: 'deptpfatitemgrid'},
       {ref: 'window', selector: 'deptpfatitemwindow'},
       {ref: 'formPanel', selector: 'deptpfatitemform'},
	    ...
	    this.control({
	    	...
	    	'button[action=add]':{
	    		click: function(){
	            	...
	            	if(!menuItemWindow){menuItemWindow = Ext.create('DeptPfatItemModule.view.DeptPfatItemWindow');}
	        ...
	        'button[action=del]': {
	        	click: function(){
	                ...
	                var rowId = sm.getLastSelected().get('id');
