/**
 * Fxstudio Override Extjs's Plugins
 */
Ext.define('CateManageModule.ex.TreeViewDragDrop', {
    extend: 'Ext.AbstractPlugin',
    alias: 'plugin.fxtreeviewdragdrop',
    ...
    onViewRender : function(view) {
        ...
        if (me.enableDrop) {
            me.dropZone = new CateManageModule.ex.ViewDropZone({
                view: view,
