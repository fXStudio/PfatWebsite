...
public class Office2PDF {
	...
	private @Value("${open_office}") String OPEN_OFFICE;

	/**
	 * 根据操作系统的名称，获取OpenOffice的安装目录 如我的安装目录：C:/Program Files (x86)/OpenOffice 4
	 */
	 ...
	 *            输出目标文件路径
	 */
	private void converterFile(String inputFilePath, String outputFilePath) {
